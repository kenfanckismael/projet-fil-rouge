    ...
    <div className="mt-4 border-t border-gray-100 pt-4">
      <div className="mb-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
          ...
          <div>
            ...
            <span className="ml-2">{order.table_id || 'Non spécifié'}</span>
          </div>
        </div>
      </div>
      ...
      <div className="mb-4">
        ...
        <div className="bg-gray-50 rounded-md overflow-hidden border border-gray-200">
          <div className="grid grid-cols-1 sm:grid-cols-5 px-4 py-2 text-xs font-medium text-gray-700 bg-gray-100">
            <div className="col-span-2 sm:col-span-2">Plat</div>
            <div>Quantité</div>
          ...
          <div className="divide-y divide-gray-200">
            {order.items.map((item) => (
              <div key={item.id} className="grid grid-cols-1 sm:grid-cols-5 px-4 py-3 text-sm hover:bg-gray-100">
